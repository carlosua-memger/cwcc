...
func insertTxn(txn *ArDtlUploadReq) {
	...
	fmt.Println("ARDTL_Upload " + txn.ArHrd + "," + txn.MemberId + "," + txn.PartnerTransType + "," + txn.Amount + ",'" + txn.Remarks + "'")
	config.LogHandler("ARDTL_Upload " + txn.ArHrd + "," + txn.MemberId + "," + txn.PartnerTransType + "," + txn.Amount + ",'" + txn.Remarks + "'")
	var rr Translog
	sqlstr := "ARDTL_Upload " + txn.ArHrd + "," + txn.MemberId + "," + txn.PartnerTransType + "," + txn.Amount + ",'" + txn.Remarks + "'"
